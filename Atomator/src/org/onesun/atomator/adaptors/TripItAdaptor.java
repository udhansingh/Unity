...
public class TripItAdaptor extends AbstractAdaptor {
	public TripItAdaptor() {
		super();
	}

	public TripItAdaptor(Channel channel) {
		super(channel);
	}

	public TripItAdaptor(Channel channel, String feedURL){
	...
	private Feed parseDocument(Document document){
		...
		// TODO: TripIt related parsing : entry might not be the node available
	...
	protected Feed parseEntries(String input) {
		try {
			...
			System.err.println("TripIt parser: Exception while parsing feed " + e.getMessage());
		}
